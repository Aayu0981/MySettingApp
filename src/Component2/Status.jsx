...
const navigate=useNavigate();
  ...
  return (
    <div  style={{width:350}}>
        ...
        <p style={{marginLeft:20}} className='heading'>Status</p>


        <div className='Modes'>
            <p className='Darktext' >Battery status</p>
        ...
        <p className='Lighttext' >BASIC INFO</p>
        ...
        <div >
            ...
            <p className='Lighttext' >DEVICE IDENTIFIERS</p>
