...
function About2() {
  ...
  return (
    <div style={{width:350}}>
     ...
     <p  style={{fontSize:30,marginBottom:5,marginLeft:30,fontWeight:300}}>All specs</p>


     <div className='one'  style={{height:250,width:330,borderRadius:20}}>
     <img src="data:image/png;base64," style={{width:20,height:20,marginTop:30}} />
      <p  className="Lighttext"style={{marginTop:0,marginBottom:0}}>RAM</p>
      <p  className="Darktext1" style={{marginTop:5}}>6.0 GB</p>

      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqPSg14mJBe136u8n8Ow9yfnH1DDG-s9SG7A&usqp=CAU" style={{width:20,marginTop:25,marginBottom:0}} />
      <p style={{marginTop:0,marginBottom:5,color:'grey',fontSize:13}}>CPU</p>
      <p  className="Darktext1" style={{marginBottom:0,marginTop:0}}>Helio G96</p>
      <p  className="Darktext1"style={{marginTop:0}}>Octa-core Max 2.05GHz</p>
     </div>

       
       <div className="one" style={{height:75,width:330,borderRadius:20,marginTop:10}}>
        <p className="Darktext1" style={{marginBottom:0}}>Android Version</p>
        <p className="Lighttext" style={{marginTop:0}}>12SP1A.210812.016</p>
       </div>

       <div className="third" style={{display:'flex'}}>
        
        <div className='one' style={{height:130,width:170,borderRadius:20,marginTop:10,marginLeft:0}}>
            <p className="Darktext1" >Android security Update</p>
            <p className="Lighttext"  style={{marginTop:40}}>2023-04-01</p>
        </div>
       

       <div className='one' style={{height:130,width:170,borderRadius:20,marginTop:10}}>
        <p className="Darktext1">MIUI version</p>
        <p className="Lighttext">MIUI Global<br/>
        13.0.5 Stable<br/>
        13.0.5.0(SKEINXM)
        </p>
       ...
       <div className="one"  style={{height:200,width:330,borderRadius:20,marginTop:10}}>
        <p className="Darktext1" style={{marginBottom:0}}>Model</p>
        <p className="Lighttext"style={{marginTop:0}}>2201117PI</p>

        <p className="Darktext1" style={{marginBottom:0}}>Baseband version</p>
       <p className="Lighttext"style={{marginTop:0}}> MOLY.LR13,R2.MP.V16.1.P59</p>

        <p style={{marginBottom:0}}  className="Darktext1">Kernel version</p>
       <p className="Lighttext"style={{marginTop:0}}> 4.14.186-perf-g8068275caa57</p>
       </div>
       

       <div className="one" style={{height:90,width:330,borderRadius:20,marginTop:10}}>
        <p  className="Darktext1" style={{marginBottom:0}}>Internal storage</p>
          <p className="Lighttext"style={{marginTop:0}}> Available storage 4.7 GB/Total storage 64.0.GB
        </p>
       
       </div>

       <div className='Modes'onClick={()=>navigate("/Legalinfo")} >
      <h5 style={{fontWeight:600,fontSize:16,marginLeft:25}}>Legal information</h5>
      <p className='Lighttext'>&gt;</p>
      </div>
       {/* <p style={{fontWeight:100}}><b>Legal information</b></p> */}
           

           <div className='Modes' onClick={()=>navigate('/Status')}>
       <h5 style={{fontWeight:600,fontSize:16,marginLeft:25}}>Status</h5>
       <p className='Lighttext'>&gt;</p>
       </div>
